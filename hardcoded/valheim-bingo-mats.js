...
var vhmats = [
//Bog Witch
 { name: "Serving Tray", description: "Set the table with whatever food and drink you fancy, and impress your guests with a delicious feast.", color: swamp },
 { name: "Scythe", description: "The right tool makes the task at hand so much easier.", color: mountain },
 { name: "Barrel Hoops", description: "These metal rings are perfectly round, suitable for holding a barrel together. Just add wood!", color: black },
 { name: "Candle Wick", description: "Steep these in something flammable for a long lasting and cosy light source.", color: swamp },
 { name: "Scythe Handle", description: "A sturdy base for a tool.", color: mountain },
 { name: "Cured Squirrel Hamstring", description: "Elastic and strong. This tendon must have come from a quick and agile animal.", color: swamp },
 { name: "Powdered Dragon Eggshells", description: "Dragon egg is a hard and difficult material to work with, yet here it has been ground to a fine, glittering dust...", color: swamp },
 { name: "Fresh Seaweed", description: "The saltwater scent of this plant makes you think of the wide open ocean.", color: swamp },
 { name: "Pungent Pebbles", description: "An earthy odour clings to these dried lumps. It's best to not think too hard about what they are.", color: swamp },
 { name: "Fragrant Bundle", description: "These plants carry a strong but pleasant scent. However, it's possible that not all creatures agree...", color: mountain },
 { name: "Toadstool", description: "Some say you can eat everything you find in the forest. That is not the case with this mushroom.", color: mountain },
 { name: "Ivy Seeds", description: "These unassuming seeds can grow into vines that might overtake entire buildings.", color: swamp },
 { name: "Woodland Herb Blend", description: "Thyme and marjoram carefully harvested and dried, before being mixed together. This blend will turn even the most basic of ingredients into a delicious feast.", color: swamp },
 { name: "Mountain Peak Pepper Powder", description: "Only the most seasoned herbalist can find the pepperwood tree and harvest its leaves and bark. After careful preparation it's ready to be added to food, and is sure to give it some warming heat.", color: mountain },
 { name: "Grasslands Herbalist Harvest", description: "This blend utilises all aspects of the lovage plant, a rarity in the tenth world. Roots, leaves and seeds have all been gathered, and then mixed together in the perfect quantity.", color: plains },
 { name: "Herbs of the Hidden Hills", description: "A good herbalist knows exactly where to go to find ramsons, but she won't tell you the secrets of her trade! Still, if you have the coin for it you may treat yourself to this blend of finely harvested ramson bulbs and leaves.", color: mistlands },
 { name: "Fiery Spice Powder", description: "Whatever spices have been used in this blend, they must come from someplace hot. And as if that wasn't enough, they have also been dried and smoked before being ground into a fine powder.", color: ashlands },
 { name: "Seafarer’s Herbs", description: "The sour tang of sorrel, mixed with something the herbalist would rather not disclose, is well suitable for fish. Any fisherfolk worth their salt would do well to keep this blend near, in case of a good catch!", color: ocean },
 { name: "Harvest Tunic", description: "When working the fields, it's important to dress accordingly. A shorter tunic lets in a cool breeze.", color: black },
 { name: "Harvest Dress", description: "When working the fields, it's important to dress accordingly. This long dress keeps your knees covered while you work.", color: black },
 { name: "Straw Hat", description: "The perfect way to avoid sunstroke.", color: black },
 { name: "Kvastur", description: "A witch's best friend.", color: swamp },
 { name: "Whole Roasted Meadow Boar", description: "A boar that has been roasted to perfection, glazed and served atop a bed of greens, with additional cuts of meat on the side. A feast like this is sure to fill your stomach and brighten your day!", color: swamp },
 { name: "Black Forest Buffet Platter", description: "You won't be able to resist this platter of delights from the Black Forest! Venison sirloin steaks are served together with spiced thistles and carrots, and the whole meal is tied together with delicious jams. Just have one more bite!", color: swamp },
 { name: "Swamp Dweller’s Delight", description: "Who knew that leeches were edible? With the correct preparation (lots of cooking and lots of seasoning) you will be able to serve them in this feast for the culinary brave. For those who have a sensitive stomach, there are also tasty skewers of sausages and turnips on the side.", color: swamp },
 { name: "Hearty Mountain Logger’s Stew", description: "Gather around this steaming pot full of deliciousness and warm yourselves up again after a day out in the cold. The usually tough and chewey wolf meat has become tender enough to practically melt in your mouth, and the onions and carrots are made even tastier with exciting spices.", color: mountain },
 { name: "Plains Pie Picnic", description: "There's nothing plain about this feast! Enjoy pies and loaves fresh from the oven, both sweet and savoury, and experience the culinary equivalent of a hug.", color: plains },
 { name: "Mushrooms Galore la Mistlands", description: "The time has come for mushroom enthusiasts to rejoice! Try different kinds of mushrooms, mushroom marinated seeker meat and mushroom-filled misthare, and don't miss out on the tasty sap dressing.", color: mistlands },
 { name: "Ashlands Gourmet Bowl", description: "It's hard to tell whether the steam coming off of this dish is because it's freshly cooked or because of the asksvin meat in it. Either way, the spiced meat together with the vineberries and fiddlehead sprouts is so delicious that it doesn't matter!", color: ashlands },
 { name: "Sailor's Bounty", description: "Fish, fish, and more fish! And also serpent meat, cut to look like fish! Explore the flavours of the Ocean, along with some grilled greens for those still practicing their sea legs.", color: ocean },
 { name: "Berserkir Mead", description: "Something poisonous stirs within, brewed to the point where its potential can finally be harnessed. But be careful to let the beast out...", color: mountain },
 { name: "Tonic of Ratatosk", description: "The squirrel must be quick on its feet as it runs up and down the trunk of the world tree. Although it no longer visits Valheim, there are still those who remember it...", color: swamp },
 { name: "Lightfoot Mead", description: "This bottle is full, yet it feels like it weighs almost nothing at all.", color: mistlands },
 { name: "Draught of Vananidir", description: "You feel invigorated just by holding this, as the ocean beckons you to come for a swim.", color: swamp },
 { name: "Mead of Troll Endurance", description: "What creature can carry more than a troll? Why, a viking with this drink of course!", color: swamp },
 { name: "Brew of Animal Whispers", description: "It smells like a pigsty. Likely the taste won't be much better.", color: swamp },
 { name: "Anti-Sting Concoction", description: "The perfect drink for a day in the Plains.", color: mountain },
 { name: "Love Potion", description: "An intense musk permeates the air around this bottle.", color: swamp },
//Ashlands
...
//Init
 ...
 { name: "Bonemass trophy", description: "Bones and viscous goo, held together by some unseen force.", color: swamp },
 ...
 { name: "Moder trophy", description: "The head of a dragon, majestic even in the rigor of death.", color: mountain },
 ...
 { name: "Eikthyr trophy", description: "This severed head oozes power.", color: meadows },
 ...
 { name: "The Elder trophy", description: "This severed head oozes power.", color: black },
